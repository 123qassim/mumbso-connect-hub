  ...
  const donationMethods = [
    {
      ...
      description: "Make an instant donation using M-Pesa Paybill. Your contribution will directly support our biotech research and student programs.",
      icon: <Heart className="h-6 w-6" />,
      details: [
        { label: "Paybill Number", value: "522522" },
        { label: "Account Number", value: "MUMBSO" },
      ],
      steps: [
    ...
    },
    {
      ...
      description: "Support our mission through Airtel Money. Funds go directly to lab equipment, research materials, and student scholarships.",
      icon: <Microscope className="h-6 w-6" />,
      details: [
        { label: "Merchant Code", value: "Coming Soon" },
        { label: "Contact", value: "treasurer@mumbso.ac.ke" },
      ],
      steps: [
        "Contact our treasurer for Airtel Money details",
        "Provide your Airtel Money account",
        "Send your donation amount",
    ...
    },
    {
      ...
      details: [
        { label: "Bank Name", value: "Maseno University Students" },
        { label: "Account Type", value: "Organization Account" },
      ],
      steps: [
        "Contact our treasurer for bank details",
        "Use the provided account information",
        "Make your transfer with reference: DONATION-MUMBSO",
